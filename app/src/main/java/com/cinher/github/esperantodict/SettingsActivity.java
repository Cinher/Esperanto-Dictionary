...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            ActivityManager.TaskDescription taskDescription = new ActivityManager.TaskDescription(getResources().getString(R.string.title_activity_settings), bm, color);
     ...
     */
    /**
     *添加新 Fragment 时须在这里添加已知的 Fragment 名
     */
    ...
    public static class SearchPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("settings_language_local"));
        }
